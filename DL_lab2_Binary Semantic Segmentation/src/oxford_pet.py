...
def random_geometric_augmentation(image, mask, p_flip=0.5, rotate_max=15):
...
class SimpleOxfordPetDataset(OxfordPetDataset):
    def __getitem__(self, *args, **kwargs):
        ...
        # 做geometric_augementation
        image, mask = random_geometric_augmentation(image, mask, p_flip=0.5, rotate_max=15)
